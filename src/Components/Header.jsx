...
export default function Header() {
  return (
    <header className='z-[999] relative'>
      ...
      bg-opacity-80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.05rem]
      sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full dark:bg-[#312f2f] dark:bg-opacity-75 dark:text-white
      dark:border dark:border-gray-400 dark:border-opacity-60'
      ...
      py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
        ...
        text-[0.9rem] text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5'  >
            <motion.li className='h-3/4 flex items-center justify-center  dark:text-white' 
                initial={{y:-100,opacity:0}}
                animate={{ y:0, opacity:1 }}>
            <ScrollLink
            className='flex w-full items-center justify-center px-3 py-3 hover:text-blue-700  dark:hover:text-green-400 transition'
            to='Home' 
            smooth={true}
            duration={500}>
              Home

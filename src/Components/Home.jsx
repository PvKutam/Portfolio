...
export default function Home() {
  return (
    ...
    dark:background-image: url("https://www.miraya.tech/assets/gradient-625d94e6.webp") dark:bg-auto dark:bg-no-repeat dark:bg-center'
    ...
    >
        <h1 className='flex flex-col  items-center justify-center z-[1] font-[400] text-[34px] mb-8 sm:text-[40px] md:text-[60px] lg:text-[75px] '>  
            <span className='bg-gradient-to-r from-[#1a1919] via-[#534f4f] to-[#444040] inline-block text-transparent bg-clip-text dark:from-[#4a4848] dark:via-[#333131] dark:to-[#534f4f]'>Hello I'm Kutam.</span>
        ...
        <p className=' leading-1.8  m-auto max-w-[350px] text-[14px] sm:max-w-[400px] sm:text-[15px] md:max-w-[640px] lg:text-[20px] dark:text-[#bbbbbb]  '>

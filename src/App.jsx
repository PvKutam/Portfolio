...
import Theme from './Components/Theme'
  ...
  function App() {
    ...
    return (
      <BrowserRouter>
      <>
      <div className="flex flex-col items-center justify-between py-10 gap-10 w-full dark:bg-[#131313]  ">
        <main className= 'bg-gray-50 text-gray-950 dark:bg-[#131313] ' >
          <div className="bg-[#fbe2e3] absolute top-[-6rem] -z-10 right-[11rem]
          h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75em] dark:-z-50 " > 
          </div>
        ...
        <div className='dark:bg-[#131313] dark:text-gray-50'>
